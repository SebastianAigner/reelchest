...
/**
 * Handler for shifting subtitles.
 */
suspend fun RoutingContext.shiftSubtitlesHandler() {
...
/**
 * Handler for embedding subtitles.
 */
suspend fun RoutingContext.embedSubtitlesHandler() {
    val multiPartData = call.receiveMultipart()
